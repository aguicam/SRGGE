...
class Viewer5: public HW
{
    Q_OBJECT
public:
    Viewer5		(const QGLFormat &glf, QWidget *parent = 0);
    ...
    void        draw_Armadillo(Eigen::Matrix4f model,Eigen::Matrix4f view,std::vector<int> visibility);
    void        draw_Bunny(Eigen::Matrix4f model,Eigen::Matrix4f view,std::vector<int> visibility);
    void        draw_Anno(Eigen::Matrix4f model,Eigen::Matrix4f view,std::vector<int> visibility);
    void        loadVisibility();
    void        LoadDic();
